...
for pixelnum in range(9):
  ...
  plt.errorbar(E,fw*E,fwe*E,capsize=3, fmt='o', markersize=3, label='pix%d' % pixelnum)
plt.legend()
plt.savefig('../figures/gaintrend_A0.png')
plt.clf()
plt.close()
...
for pixelnum in range(9,18):
  if pixelnum != 12 :
    ...
    plt.errorbar(E,fw*E,fwe*E,capsize=3, fmt='o', markersize=3, label='pix%d' % pixelnum)
plt.legend()
plt.savefig('../figures/gaintrend_A1.png')
plt.clf()
plt.close()
...
for pixelnum in range(18,27):
    ...
    plt.errorbar(E,fw*E,fwe*E,capsize=3, fmt='o', markersize=3, label='pix%d' % pixelnum)
plt.legend()
plt.savefig('../figures/gaintrend_B0.png')
plt.clf()
plt.close()
...
for pixelnum in range(27,36):
    ...
    plt.errorbar(E,fw*E,fwe*E,capsize=3, fmt='o', markersize=3, label='pix%d' % pixelnum)
plt.legend()
plt.savefig('../figures/gaintrend_B1.png')
plt.clf()
plt.close()
...
plt.errorbar(E,fw*E,fwe*E,capsize=3, fmt='o', markersize=3, label='all')
plt.legend()
