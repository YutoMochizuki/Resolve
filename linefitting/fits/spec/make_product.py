...
#lightcurveとspecを作ってlinefittingできるようにする汎用プログラム(mxs以外)
...
r_file = "event_out_enelimit.fits"
...
df1.to_csv('/Users/mochizuki/Desktop/Resolve_linefitting/fits/spec/spec_all.txt', sep=' ', index=None, header=None)
